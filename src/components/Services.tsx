...
export default function Services() {
  return (
    <section id="servicios" className="relative bg-dark py-20 lg:py-[120px]">
      <div
        aria-hidden
        className="pointer-events-none absolute left-0 top-1/2 h-[1700px] w-[1700px] -translate-x-1/2 -translate-y-1/2 bg-cover bg-center opacity-70 mix-blend-screen"
